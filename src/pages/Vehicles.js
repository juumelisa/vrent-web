...
export const Vehicles = ({getVehicles, getNextData}) =>{
                ...
                <div className="search-filter col-12 col-md-3 my-2">
                    <form onSubmit={onSearch} id='search' className="search">
                      <div className="d-flex align-items-center">
                        ...
                        <p className="d-md-none m-0 p-0 ms-auto" onClick={() => setShowFilter(!showFilter)} style={{cursor: "pointer"}}><u>{showFilter ? 'Hide' : 'Show'}</u></p>
                      </div>
                      <div className={`${showFilter ? 'd-block' : 'd-none'} d-md-block`}>
                        <input className="py-3 my-2" name="name" type="text" placeholder="Vehicle name" style={{width: "100%"}}/>
                        <input className="py-3 my-2" name="location" type="text" placeholder="Location" style={{width: "100%"}} />
                        <input className="py-3 my-2" name="cost_min" type="number" placeholder="Minimum cost" style={{width: "100%"}} />
                        <input className="py-3 my-2" name="cost_max" type="number" placeholder="Maximum cost" style={{width: "100%"}} />
                        ...
                        <select id="sortBy" className="my-2">
                        ...
                        <div className='row my-5'>
                            <div className='col'>
                                <div className='alert alert-danger' role='alert'>
                                    <span>{vhc.errMsg}</span>
                                </div>
                            </div>
                        </div>
                    }
                    {vhc.isLoading && <div className="d-flex justify-content-center align-items-center vh-100">
                      <img src={loadingGif} width={100} height={100} alt="loading" />
                    </div>}
                    {!vhc.isLoading && !vhc.isError && <div className="row vehicles">
