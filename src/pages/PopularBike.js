...
export function PopularCarBike() {
  ...
  const getVehicles = async () => {
    const { data } = await axios.get(`${process.env.REACT_APP_URL}/popular?category=3&sortBy=totalRent+DESC&limit=4`);
      ...
      <div className="popular-section py-5">
        <div className="heading-section d-flex align-items-center" style={{ width: '100%' }}>
          ...
          <div className="other-vehicles text-end" style={{ width: '50%' }}>
            <Link to="/popular-bike" style={{ color: '#1572A1' }}>
              View all
